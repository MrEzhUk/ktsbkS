...
@DatabaseTable(tableName = "account_buy_history")
public class KtsAccountBuyHistory {
    public static final Dao<KtsAccountBuyHistory, Long> DAO = KtsDbSource.INSTANCE.createDao(KtsAccountBuyHistory.class);
